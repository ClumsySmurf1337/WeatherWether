...
- Levels must teach and stress the **core mechanic**: weather **card order/placement** and **six weathers** on a grid; reserve **fog** for appropriate world progression per Building Weather Whether.
- Preserve solvability.
- Follow world progression constraints in Building Weather Whether / blueprint docs.
