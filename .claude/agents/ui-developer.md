...
- Keep interaction flows consistent with `docs/ART_DIRECTION.md`, `docs/STITCH_UX_WORKFLOW.md`, and Building Whether UX guidance.
...
- UI must support the **core loop**: readable **weather hand**, grid targeting, and later **fog** affordances per the Building Whether doc.
